        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className={cn(
            ...
            <div className="flex items-center gap-1.5 mt-0.5 overflow-hidden">
              <span className={cn(
                "text-[10px] font-bold px-1.5 py-0.5 rounded-md uppercase tracking-wider flex-shrink-0",
                mode === 'dark'
                  ? "text-indigo-300 bg-indigo-950/50 border border-indigo-900/50"
                  : "text-indigo-700 bg-indigo-50/80 border border-indigo-100/70"
              )}>
                {user.role}
              </span>
            </div>
            ...
            <Link
              ...
              className={cn(
                ...
                pathname === '/staff/settings'
                  ? (mode === 'dark' ? 'bg-white text-slate-950 shadow-[0_2px_8px_rgba(255,255,255,0.12)]' : 'bg-slate-900 text-white shadow-sm')
                  : (mode === 'dark' ? 'text-slate-400 hover:bg-white/10 hover:text-white' : 'text-slate-600 hover:bg-white/55 hover:text-slate-900 hover:backdrop-blur-sm')
              )}
            >
            ...
            <div className={cn(
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col justify-center">
                  ...
                  <span className={cn("text-[12px] font-medium leading-tight mt-0.5", mode === 'dark' ? "text-slate-300" : "text-slate-700")}>Staff Portal</span>
                </div>
              </div>
              <button
                onClick={() => setIsMobileOpen(false)}
            ...
            <div className="px-3 pb-5">
              ...
              <Link
                ...
                className={cn(
                  ...
                  mode === 'dark' ? "text-slate-400 hover:bg-white/10 hover:text-white" : "text-slate-600 hover:bg-white/55 hover:text-slate-900"
                )}
              >
                <Settings className={cn(
                  "w-[18px] h-[18px] flex-shrink-0 transition-colors",
        ...
        <div className="mx-auto max-w-md w-full bg-white/75 backdrop-blur-[20px] [-webkit-backdrop-filter:blur(20px)] border border-white/60 rounded-[20px] shadow-[0_8px_32px_rgba(15,23,42,0.08)] flex justify-around items-center p-2 pointer-events-auto">
          ...
          <Link
            ...
            className={cn(
              ...
              pathname === "/staff/dashboard" ? "text-blue-600 bg-blue-50/50" : "text-slate-600 hover:text-slate-900"
            )}
          >
          ...
          <Link
            ...
            className={cn(
              "flex flex-col items-center justify-center py-1.5 px-3 rounded-[12px] transition-all",
              pathname.startsWith("/staff/students") ? "text-blue-600 bg-blue-50/50" : "text-slate-600 hover:text-slate-900"
            )}
          >
          ...
          <Link
            ...
            className={cn(
              "flex flex-col items-center justify-center py-1.5 px-3 rounded-[12px] transition-all",
              pathname.startsWith("/staff/fees") ? "text-blue-600 bg-blue-50/50" : "text-slate-600 hover:text-slate-900"
            )}
          >
          ...
          <Link
            ...
            className={cn(
              "flex flex-col items-center justify-center py-1.5 px-3 rounded-[12px] transition-all",
              pathname.startsWith("/staff/results") ? "text-blue-600 bg-blue-50/50" : "text-slate-600 hover:text-slate-900"
            )}
          >
