...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex items-center justify-start rounded-[14px] p-1 gap-0.5",
      "bg-white/55 backdrop-blur-[14px] [-webkit-backdrop-filter:blur(14px)]",
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      // Active state: dark premium pill
      "data-[state=active]:bg-slate-900 data-[state=active]:text-white",
      "data-[state=active]:shadow-[0_2px_6px_rgba(15,23,42,0.18)]",
      className
    )}
    {...props}
  />
